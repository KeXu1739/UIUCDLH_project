...
class MimicParser(object):
    ...
    def create_day_blocks(self, file_name):
        ...
        df3.columns = ["{0}_std".format(i) for i in list(df3.columns)] # edited by Haixu, because of column # mismatch
        ...
        df4.columns = ["{0}_min".format(i) for i in list(df4.columns)] # edited by Haixu, because of column # mismatch
        ...
        df5.columns = ["{0}_max".format(i) for i in list(df5.columns)] # edited by Haixu, because of column # mismatch
